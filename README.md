...
Configure your [config file](https://hub.steampipe.io/plugins/turbot/rss#configuration) to include default feed links. Feed link must be provided either in where clause or should be configured as default feed links in the config file.
